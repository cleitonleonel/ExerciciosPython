...
Dado um ponto A, simule o deslocamento do mesmo até um novo ponto B. A cada repetição de loop você deve alterar
 as coordenadas de A até que tenha a mesma coordenada de B. O ponto A tem velocidade fixa e se desloca a 4px/loop.